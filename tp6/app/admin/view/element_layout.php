...
<head>
    ...
    <!--  Element UI START  -->
    <!-- 引入样式 -->
    <link rel="stylesheet" href="/statics/admin/theme/elementui/elementui_2.15.7/index.css">
    <!-- 引入组件库 -->
    <script src="/statics/admin/theme/elementui/elementui_2.15.7/index.js"></script>
    <!--  Element UI END  -->
    <style>
        /* vue相关  */
        [v-cloak] {
